<?php
	...
	*/
	class Code_For_Notification_Sendable_Table{
		...
		const CODE  = array("comment"=>"c-", "reply"=>"r-", "reply_notify_post_user"=>"rn-","interest_request"=>"ir-", "interest_request_accept"=>"ira-", "message_queue"=>"mq-", "favor_activity"=>"fa-", "favor_comment"=>"fc-", "favor_reply"=>"fr-");
